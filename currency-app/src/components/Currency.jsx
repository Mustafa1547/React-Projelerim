...
let API_KEY = "fca_live_HIGclsZCRbYxWve673SQWJyc7xBPXzB0oHUzljNq"
...
function Currency() {
    ...
    const exchange = async () => {
        ...
        const result = (response.data.data[toCurrency] * amount).toFixed(2);  //toFixed(2) virgülden sonra 2 basamak tek görünsün
        setResult(result);
